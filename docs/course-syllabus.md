...
Not every topic here has equal career value, so the curriculum is organized into **three tiers** by leverage. Work top-down: each tier assumes the one above it. The module numbers are stable identifiers (they don’t imply order) — the **tier** is the organizing principle.

| Tier | What it buys you | Modules |
| :--- | :--- | :--- |
| **1 · Non-Negotiable Foundation** | The bedrock every senior is assumed to have. Go until it’s intuitive. | 01 JS Runtime · 02 Browser as OS · 08 Network Bridge |
| **2 · The Differentiators** | Where market value rises sharply — most senior devs never go here. | 03 Reactivity · 04 Data Structures · 05 Compilers · 10 Build Systems |
| **3 · Rare-Engineer Territory** | Build the things, read the masters, push past JavaScript. | 06 Build From Scratch · 11 Browser APIs · 07 Source-Reading · 09 WebAssembly |
